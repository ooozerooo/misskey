...
>
	...
	<div v-if="isRenote" class="renote">
		...
		<div class="info">
			...
			<span class="visibility" style="margin-left: 0.5em;" :title="i18n.ts._visibility[note.visibility]">
				<i v-if="note.visibility === 'public'" class="ti ti-world"></i>
				<i v-if="note.visibility === 'home'" class="ti ti-home"></i>
				<i v-else-if="note.visibility === 'followers'" class="ti ti-lock"></i>
				<i v-else-if="note.visibility === 'specified'" ref="specified" class="ti ti-mail"></i>
			</span>
			<span v-if="note.localOnly" style="margin-left: 0.5em;" :title="i18n.ts._visibility['disableFederation']"><i class="ti ti-access-point-off"></i></span>
		</div>
	</div>
			...
			<div class="body">
				<div class="top">
					...
					<div class="info">
						...
						<span v-if="appearNote.localOnly" style="margin-left: 0.5em;" :title="i18n.ts._visibility['disableFederation']"><i class="ti ti-access-point-off"></i></span>
					</div>
				</div>
